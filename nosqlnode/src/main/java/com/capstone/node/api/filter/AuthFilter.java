...
public class AuthFilter implements Filter {
    ...
    private final List<Node> nodes = DatabaseManager.getInstance().getConfiguration().getNodes();
    private final String bootstrapAddress = DatabaseManager.getInstance().getConfiguration().getBootstrapAddress();
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if(url.startsWith("/auth") || isNodeAccess(req)) {
